...
$query_rsBrands = "SELECT BrandID, BrandName FROM brand ORDER BY BrandName ASC";
...
<title>Piano Street - Admin-Brand Listing</title>
<!-- InstanceEndEditable -->
...
<?php require_once('../includes/navigation.php'); ?>
  ...
  <tr>
    <td id="tdContent" bgcolor="#FFFFCC"><h1 align="center"> The Piano Street</h1>
      ...
      <p>Admin :<!-- InstanceBeginEditable name="Section Name" --> Brand Listing<!-- InstanceEndEditable --></p>
      <!-- InstanceBeginEditable name="Body Content" -->
      <p>This is a list of all brands of piano      </p>
      <form id="form1" name="form1" method="post" action="">
        <p>&nbsp;</p>
        <p><a href="../brand/add.php">Add a new Brand</a></p>
        <table width="156" border="1">
          <tr>
            <th width="146">BrandName</th>
          </tr>
          <?php do { ?>
            <tr>
              <td><a href="../brand/edit.php?BrandID=<?php echo $row_rsBrands['BrandID']; ?>"><?php echo $row_rsBrands['BrandName']; ?></a></td>
            </tr>

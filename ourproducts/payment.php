...
$_SESSION['CardID']= mysql_insert_id();
  $insertGoTo = "../ourproducts/Paid.php?CardID=" . $_SESSION['CardID'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<tr>
  ...
  <tr>
    <td align="left" id="tdContent" ><h1>&nbsp;</h1><h1  align="center"> The Piano Street</h1>
      ...
      <h2>Card Details</h2>
      <p>&nbsp;</p>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('CardNo','','RinRange1000000000000000:10000000000000000','CardholderName','','R','Bank','','R','PaymentType','','R','AMOUNT','','RisNum');return document.MM_returnValue">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">CardNo:</td>
            <td><input name="CardNo" type="text" id="CardNo" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">CardholderName:</td>
            <td><input name="CardholderName" type="text" id="CardholderName" pattern="[a-zA-Z\.]{5,15}" value="" size="32" maxlength="15" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">ExpiryDate:</td>
            <td><input name="ExpiryDate" type="date" id="ExpiryDate" max="2017-11-30" min="2014-3-17" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Bank:</td>
            <td><input name="Bank" type="text" id="Bank" pattern="[a-zA-Z]{5,15}" value="" size="32" maxlength="15" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">CardType:</td>
            <td><select name="CardType">
              <option value="1" <?php if (!(strcmp(1, 1))) {echo "SELECTED";} ?>>Credit</option>
              <option value="0" <?php if (!(strcmp(0, 1))) {echo "SELECTED";} ?>>Debit</option>
            </select></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="Insert card details" /></td>
          </tr>
        </table>

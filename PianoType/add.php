...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pianotype (TypeName) VALUES (%s)",
  ...
  $insertGoTo = "/User Authentication/admin/PianoType/index.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Piano Street - Admin-Add PianoType</title>
...
<?php require_once('../includes/navigation.php'); ?>
  ...
  <tr>
    <td id="tdContent" bgcolor="#FFFFCC"><h1 align="center"> The Piano Street</h1>
      ...
      <p>Admin :<!-- InstanceBeginEditable name="Section Name" -->Add PianoType<!-- InstanceEndEditable --></p>
      <!-- InstanceBeginEditable name="Body Content" -->
      <p>Fill the form below to add ProductType</p>
      <p>&nbsp;</p>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('TypeName','','R');return document.MM_returnValue" spry:test="(Yes)">
        <table align="center">
          <tr valign="baseline">
            ...
            <td>
            <input name="TypeName" type="text" required="required"  id="TypeName" pattern="[a-zA-Z\s]{4,15}" value="" size="32"  maxlength="15"  />
            </td>
          </tr>
          <tr valign="baseline">
